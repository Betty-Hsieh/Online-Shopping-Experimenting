...
if($_POST!=""){
	if($_POST["student_id"]=="" || $_POST["student_gender"]=="" || $_POST["student_tel"]=="" || $_POST["student_name"]==""){
		...
		$sqlbuy="INSERT INTO `buy`(`student_name`, `student_id`, `student_sex`, `student_tel`, `total_price`, `bonus_num`, `team`) VALUES ('".$_POST["student_name"]."',".$_POST["student_id"].",".$_POST["student_gender"].",".$_POST["student_tel"].",".$_POST["endprice"].",'".$bonus_id."',5)";
		mysql_query($sqlbuy);
