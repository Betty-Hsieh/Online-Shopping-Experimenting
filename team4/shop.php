				...
				?>
                    <li class="caritem">
                        <div class="row cart_main">
                         ...
                         <?php 
							...
							while($addproduct=mysql_fetch_array($result_addproduct)){
								$twoprice=$product["pro_price"]+$addproduct["pro_price"];
						?>
                        <div class="row cart_add">
                            ...
                            <div class="col-sm-1">只要<?php echo $twoprice ?>元買</div>
                            <div class="col-sm-1"><figure class="img-responsive car_img"><img class="product_img" src="../images/product/<?php echo $product_img[0] ?>"  /></figure></div>
                            <div class="col-sm-1">+</div>
                            <div class="col-sm-1"><figure><img class="add_img img-responsive"  src="../images/product/<?php echo $addproduct["pro_img"] ?>"/></figure></div>
                            <div class="col-sm-7 text-left"><?php echo $addproduct["pro_name"] ?></div>
                        </div>
                        <?php } ?>
                    </li>		
               <?php
