				...
				?>
                    <li class="caritem">
                        ...
                        <div class="row cart_add">
                            ...
                            <div class="col-sm-2"><?php echo $addproduct["pro_name"] ?></div>
                            <div class="col-sm-5">加購商品</div>
                            <div class="col-sm-1">1</div>
                            <div class="col-sm-1"><?php echo $addproduct["pro_price"] ?>元</div>
                        </div>
                        <?php
							}
						?>
